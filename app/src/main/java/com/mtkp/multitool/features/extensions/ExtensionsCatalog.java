...
public final class ExtensionsCatalog {
    ...
    public static List<ExtensionItem> getMockExtensions() {
        ...
        items.add(new ExtensionItem(
                ...
                12450,
                4.8f,
                new int[]{R.string.category_productivity, R.string.category_education},
        ...
        items.add(new ExtensionItem(
                ...
                8930,
                4.6f,
                new int[]{R.string.category_utilities, R.string.category_media},
        ...
        items.add(new ExtensionItem(
                ...
                4580,
                4.4f,
                new int[]{R.string.category_productivity, R.string.category_personalization},
        ...
        items.add(new ExtensionItem(
                ...
                6700,
                4.9f,
                new int[]{R.string.category_education, R.string.category_productivity},
        ...
        items.add(new ExtensionItem(
                ...
                2140,
                4.1f,
                new int[]{R.string.category_media, R.string.category_utilities},
        ...
        items.add(new ExtensionItem(
                ...
                15200,
                4.7f,
                new int[]{R.string.category_personalization, R.string.category_productivity},
        ...
        items.add(new ExtensionItem(
                ...
                3180,
                4.0f,
                new int[]{R.string.category_other, R.string.category_utilities},
